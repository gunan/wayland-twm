...
static const char *usable_font_description(const char *font) {
	/* XLFD names are meaningful to Xlib, not Fontconfig/Pango. */
	return font && font[0] && font[0] != '-' ? font : "Sans Bold 10";
}
...
int wtwm_measure_font_height(const char *font) {
	...
	PangoFontDescription *description =
		pango_font_description_from_string(usable_font_description(font));
