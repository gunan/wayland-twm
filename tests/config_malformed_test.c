...
static const struct malformed_case cases[] = {
	...
	{"unterminated quoted menu name", "Menu \"broken", 1, "expected '{'"},
	{"trailing escape in quoted name", "Menu \"broken\\", 1, "expected '{'"},
	...
	{"compatibility block truncated", "Cursors {\n Frame \"left_ptr\" { nested\n", 3, "unterminated block"},
	...
	{"key binding action argument missing", "\"F1\" = m : all : f.exec", 1, "expected a string"},
	{"button number zero", "Button0 = : root : f.move\n", 1, "invalid button"},
	{"button number too large", "Button33 = : root : f.move\n", 1, "invalid button"},
};
