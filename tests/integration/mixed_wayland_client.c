...
int main(void) {
	...
	/* The first barrier discovers and binds wl_seat. The second dispatches the
	 * capability event generated by that bind, which creates wl_keyboard. */
	if (wl_display_roundtrip(client.display) < 0) {
		fprintf(stderr, "mixed Wayland client: registry barrier failed\n");
		return EXIT_FAILURE;
	}
